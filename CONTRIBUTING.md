...
src/
  ...
  db/                 SQLite client with WAL mode and schema migrations (v1–v10), with declarative migration registry in db/migrations/
...
- **Database** is SQLite with auto-migrating schema. The current version is v10.
