...
This project is indexed by GitNexus as **kai** (4150 symbols, 9393 relationships, 209 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
